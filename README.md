...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/floral-waterfall-93e8
```

A live public deployment of this template is available at [https://floral-waterfall-93e8.templates.workers.dev](https://floral-waterfall-93e8.templates.workers.dev)
